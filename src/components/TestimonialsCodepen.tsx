...
export type Testimonial = {
  ...
  role?: string;
  avatar?: string;
  source?: "google" | "linkedin"; // <- pris depuis ACF
  sourceUrl?: string;
};
...
/* =========================
   1) Icônes marque officielles
   ========================= */

/** Google "G" multicolore (source: guidelines simplifiées) */
...
/** LinkedIn “in” officiel (bleu + “in” blanc) */
...
export default function TestimonialsCodepen({
  ...
  // Autoplay + réduction de mouvement
  ...
  const start = () => {
    if (!autoplay || total <= 1 || reduceMotion.current) return;
  ...
  /* Avatar: utilise logos réels si source, sinon initiales/générique */
      ...
      const badge = (
        <div
          ...
          style={{
            ...
            display: "grid",
            placeItems: "center",
            background: "rgba(255,255,255,0.03)", // neutre pour laisser la couleur du logo
  ...
  return (
    ...
    >
      <p className="visually-hidden" aria-live="polite">
        Témoignage {current + 1} sur {total}
      </p>
      ...
      <div className="wrap">
        ...
        {/* Slides */}
        <div id="testim-content" className="cont" role="region" aria-live="off">
          {items.map((t, i) => {
